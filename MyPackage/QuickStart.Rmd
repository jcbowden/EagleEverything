...
library(Eagle)
```
<font style="font-variant: small-caps"><center> <h1>Eagle V1.0</h1> </center></font>
<font style="font-variant: small-caps"><center> <h2>Quick Start Guide</h2> </center></font>
<center> <h4>Andrew W. George</h4> </center>
<br><br>


Our starting point in writing this guide is that you have a current version 
of  [R](https://www.r-project.org/about.html)
 on your computer and that you have 
managed to install the R package,  Eagle.

# Formats for the marker data

The marker data can either be in [PLINK](https://www.cog-genomics.org/plink/1.9/) ped format 

![optional caption text](images/QS_PLINK.jpg)


or a plain space delimited text file. 


![optional caption text](images/QS_plaintext.jpg)


# Format for the phenotypic data

The phenotypic data file is a plain, space delimited, text file with or without column headings
